...
internal static class Program
{
    private static int Main(string[] args)
    {
        ...
        if (command == "sanity")
        {
            ...
            ClearSkySanity.Run(latitude: 51.02095, longitude: 6.89422, altitude: 50.0, "Europe/Berlin");
            return 0;
        }
        ...
        Console.WriteLine($"{intervals.Count:N0} intervals, {days.Count:N0} days " +
        ...
        switch (command)
        {
            ...
            default:
                Console.Error.WriteLine(
                    $"Unknown command '{command}'. Try: summary, zenith, fitcoords, sanity");
                return 1;
        }
