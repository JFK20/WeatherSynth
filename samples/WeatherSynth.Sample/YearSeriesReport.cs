...
public static class YearSeriesReport
{
    public static void Run(IReadOnlyList<DwdSolarDay> days, DwdStation station, string[] args)
    {
        ...
        {
            Console.WriteLine(
                $"{day.Date:yyyy-MM-dd} {day.ClearSkyIndex, 9:F3} "
        ...
        {
            Console.WriteLine(
                $"{month.Month, 5} {month.Days, 6} {month.MeanClearSkyIndex, 12:F3} "
        ...
        Console.WriteLine();
        Console.WriteLine(
            $"  {generated.Days.Count} days, annual total {generated.GhiKWhPerM2:F0} kWh/m², "
                + $"mean index {generated.MeanClearSkyIndex:F3}"
        );
        Console.WriteLine(
            $"  Against a clear-sky ceiling of {generated.ClearSkyKWhPerM2:F0} kWh/m², "
