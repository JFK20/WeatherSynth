...
namespace WeatherSynth.Solar
{
    ...
    public sealed class SolarPositionCalculator
    {
        ...
        public double GeometricZenithDegrees(DateTimeOffset instant)
        {
            ...
            double trueSolarHours =
                utc.TimeOfDay.TotalHours + _longitude / 15.0 + eotMinutes / 60.0;
        ...
        private readonly record struct DayTerms(
