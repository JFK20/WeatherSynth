...
namespace WeatherSynth.Solar
{
    ...
    public readonly struct ClearSkySample
    {
        ...
        public ClearSkySample(
            DateTimeOffset localTime,
            double apparentZenithDegrees,
            ClearSkyIrradiance irradiance
        )
        {
            LocalTime = localTime;
    ...
    public readonly struct DailyClearSky
    {
        ...
        public DailyClearSky(
            double ghiWhPerM2,
            double dhiWhPerM2,
            double peakGhiWPerM2,
    ...
    public sealed class DailyClearSkyCalculator
    {
        ...
        )
        {
            ...
            if (_step <= TimeSpan.Zero || _step > TimeSpan.FromHours(1))
                throw new ArgumentOutOfRangeException(
                    nameof(step),
                    "Use a step between 1 minute and 1 hour."
                );
        }
        ...
        public double ApparentZenithDegrees(DateTimeOffset instant)
        {
            ...
            return 90.0
                - (geometricElevationDeg + RefractionCorrectionDegrees(geometricElevationDeg));
        }
                ...
                arcseconds =
                    ...
                    + elevationDegrees
                        * (
                            -518.2
                            + elevationDegrees
                                * (103.4 + elevationDegrees * (-12.79 + elevationDegrees * 0.711))
                        );
            }
            else
            {
        ...
        /// </summary>
        public double IntegrateGhiWhPerM2(
        ...
        )
        {
            ...
            for (var t = startInclusive; t < endExclusive; t = t.Add(_step))
            {
                ...
                wh +=
                    ClearSkyIneichen.ExtraterrestrialNormalIrradiance(midpoint.DayOfYear)
                    * cosZenith
                    * duration.TotalHours;
            }
