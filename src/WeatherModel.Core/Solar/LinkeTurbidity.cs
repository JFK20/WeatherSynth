...
namespace WeatherModel.Solar
{
    ...
    public sealed class LinkeTurbidityTable
    {
        ...
        /// </summary>
        public static LinkeTurbidityTable BochumFitted { get; } = new(new[]
        {
            2.68, // Jan
            2.72, // Feb
            2.91, // Mar
        ...
        {
            2.7, 2.9, 3.3, 3.7, 4.0, 4.2, 4.2, 4.1, 3.6, 3.1, 2.8, 2.6
        });
    ...
    public static class LinkeTurbidity
    {
        ...
        /// </summary>
        public static double Default(DateTime date) => LinkeTurbidityTable.BochumFitted.Interpolated(date);
    }
}
