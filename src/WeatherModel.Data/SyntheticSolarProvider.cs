...
public sealed class SyntheticSolarProvider
{
    ...
    public static SyntheticSolarProvider FromStationDays(
        IEnumerable<DwdSolarDay> days, DwdStation station)
    {
    ...
    public SyntheticSolarYear GenerateYear(int year, int seed) => GenerateYear(year, seed, _fittedAt);
    ...
    public IEnumerable<SyntheticSolarDay> Generate(
        DateOnly start, DateOnly endInclusive, int seed, SolarSite? site = null) =>
