...
public class SolarPositionTests
{
    ...
    public void Refraction_correction_is_about_half_a_degree_at_the_horizon()
    {
        ...
        DailyClearSkyCalculator
            .RefractionCorrectionDegrees(-0.575)
            .Should()
            .BeApproximately(0.575, 0.005);
        DailyClearSkyCalculator
            .RefractionCorrectionDegrees(0.0)
            .Should()
            .BeApproximately(0.482, 0.005);
        ...
        {
            DailyClearSkyCalculator
                .RefractionCorrectionDegrees(elevation)
                .Should()
                .BeLessThan(DailyClearSkyCalculator.RefractionCorrectionDegrees(elevation - 1.0));
        }
    }
